    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Текстовое описание рецепта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(max_length=7, unique=True, validators=[django.core.validators.RegexValidator('^#[A-Fa-f0-9]{6}$', message='Введите цвет в формате HEX')], verbose_name='Цвет')),
