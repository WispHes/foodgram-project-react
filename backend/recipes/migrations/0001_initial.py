# Generated by Django 3.2.16 on 2023-03-17 13:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='ingredient_amounts', through='recipes.IngredientAmount', to='recipes.Ingredient', verbose_name='Список ингредиентов')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(max_length=7, unique=True, validators=[django.core.validators.RegexValidator('^#([A-Fa-f0-9]{3}){1,2}$', message='Введите цвет в формате HEX')], verbose_name='Цвет')),
